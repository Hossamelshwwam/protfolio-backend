...
router.post('/', (0, validate_middleware_1.validate)(experience_validation_1.createExperienceSchema), ExperienceController.createExperience);
router.patch('/:id', (0, validate_middleware_1.validate)(experience_validation_1.updateExperienceSchema), ExperienceController.updateExperience);
