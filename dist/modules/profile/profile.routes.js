...
router.patch('/', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(types_1.UserRole.ADMIN), upload_middleware_1.uploadProfileFiles, // Multer intercepts `logo` and `cv` file streams here
